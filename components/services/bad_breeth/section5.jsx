...
export default function Cosmetic5({ CustomComponent }) {
    const treatments = [
      ...
      },
      {
        ...
        description:
          "One of the most highly sought-after types of cosmetic dentistry in Melbourne, porcelain veneers can be used to improve the appearance of your smile and restore your natural bite. At Main Street Dental Practice Bacchus Marsh, our cosmetic dentist in MSDP can provide you with long-lasting veneers that are bonded to your teeth in order to enhance your smile.",
      },
      {
        title: "Braces",
        description:
    ...
    return (
        <div>
      <div style={{ fontFamily: "OptimaModoki, sans-serif" }} className="bg-[#1C4C57] w-full text-white py-16 px-4">
        {/* Heading Section */}
        ...
        {/* Treatments Section */}
        <div className="bg-[#1C4C57] max-w-6xl mx-auto  mt-8 space-y-6 px-4">
