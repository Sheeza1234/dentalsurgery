...
export default function Navbar() {
  ...
  return (
    <div>
      {/* Top Info Bar */}
      <header className="fixed bg-[#1C4C57] text-white py-2 w-full z-50 top-0 left-0">
        <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-center gap-4 md:justify-between px-4">
          {/* Address */}
      ...
      <div className="fixed top-[60px] right-4 flex flex-col items-end space-y-2 z-50">
      ...
      {/* Main Navbar */}
      <nav className="fixed top-[120px] left-0 w-full bg-[#C7EFFF] z-50 py-3 px-4 flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
        {/* Logo */}
